...
describe("IronRoad Freight seed", () => {
  ...
  it("expected findings carry the engineered dollar figures", () => {
    ...
    expect(r12.annualizedSavingsCents).toBe(1_370_400); // $13,704.00
    expect(r12.recoverableToDateCents).toBe(1_370_400);
  });
});
