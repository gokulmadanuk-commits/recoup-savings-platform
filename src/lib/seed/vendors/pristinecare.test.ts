...
describe("PristineCare Facilities seed", () => {
  ...
  it("expected findings carry the engineered dollar figures", () => {
    ...
    expect(r04.annualizedSavingsCents).toBe(1_422_000); // $14,220.00
    expect(r04.recoverableToDateCents).toBe(1_422_000);
  });
});
