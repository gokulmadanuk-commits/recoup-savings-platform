...
import seed from "./harbor-benefits-brokers";
...
describe("Harbor Benefits Brokers seed", () => {
  ...
  it("expected findings have positive, engineered savings", () => {
    ...
    const r14 = expected.find((f) => f.ruleId === "R14")!;
    expect(r14.annualizedSavingsCents).toBe(11_520_00);
  });
});
